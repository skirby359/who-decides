...
# This script loads the FEC committee master and seeds party overrides, which lives in the private
...
TMP = "C:/Users/kirby/AppData/Local/Temp/fec_bulk_ny"  # outside Dropbox
